...
const Guide = () => {
  ...
  return (
    <>
      ...
      {/* GUIA VISUAL */}
      <div id="print-guide" className="bg-[#f7fbff] border border-[#d7f3fa] rounded-2xl shadow-xl p-6 md:p-8">
        {/* ENCABEZADO */}
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="bg-[#5a2290] text-white rounded-full p-2">
              <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-extrabold text-[#5a2290]">Guía Paso a Paso</h1>
              <p className="text-sm text-[#11acd3]">Tiempo estimado: 10 minutos</p>
            </div>
          </div>
          <button onClick={handlePrint} className="no-print bg-[#63ed12] hover:bg-[#54cb0f] text-[#103b07] font-bold py-2 px-4 rounded-lg shadow flex items-center gap-2 transition">
        ...
        {/* TIPS FINALES */}
        <div className="mt-6 bg-[#f3ecfb] border-l-4 border-[#5a2290] rounded p-4">
          <h4 className="font-bold text-[#5a2290] mb-2">Tips rápidos</h4>
          <ul className="list-disc list-inside text-sm text-[#7444a5] space-y-1">
...
const steps = [
  ...
  },
  {
    ...
    details: [
      { label: "Filtro", text: "Usa el combobox “Filtrar docente” para enfocarte; “Mostrar todos” para volver." },
